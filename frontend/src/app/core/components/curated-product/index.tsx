    ...
    return (
        <>
            {merch.products?.map((product: any, productIndex: number) => (
                <Product product={product} current={current} productIndex={productIndex} />
            ))}
        </>
    );
}
            ...
            <div className="flex gap-2 justify-between flex-wrap items-center py-2">
                <div className="flex items-center ">
                    ...
                    <div className="pl-4 pb-2">
                        ...
                        <Price priceVariants={selectedVariant.priceVariants} renderType="microformat" />
                    </div>
                </div>
