...
export const Banner: React.FC<TileViewComponentProps> = ({ tile }) => {
    ...
    return (
        <div className={`pl-10 flex md:flex-row flex-col container 2xl w-full mx-auto  ${isFullWidth ? 'items-center' : 'pt-20'}`}>
            <div className={`${!images?.length ? 'py-20' : ''} items-center flex-column pr-8 md:w-4/12 w-full relative z-10`}>
