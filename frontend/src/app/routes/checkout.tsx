              ...
              return (
                <>
                  ...
                  <button
                    ...
                    onClick={async () => {
                      setPaying(true);
                      const orderConfirmation = await sendPaidOrder(
                        basket,
                        userInfos
                      );
                      emptyBasket();
                      navigate(`/order/${orderConfirmation.order.id}`, {
                        replace: true,
                      });
                    }}
                  >
...
export const Form: React.FC = () => {
  ...
  return (
    <>
      <p className="mb-5">
        You need to register to place you order. We'll send you a magick link.
      </p>
      <form
